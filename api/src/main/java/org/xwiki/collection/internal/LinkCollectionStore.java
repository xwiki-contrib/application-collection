...
/**
 * Knows how link collections are stored.
 * 
 * @version $Id$
 */
@Component
@Singleton
@Named("link")
public class LinkCollectionStore implements CollectionStore
{
    @Inject
    ...
    public void load(DocumentReference collectionReference, CollectionFilter filter)
    {
        ...
        // TODO: Collect the documents that are reachable through links from the root document.
    }
    ...
    public DocumentReference getTemplateReference()
    {
        return new DocumentReference(documentAccessBridge.getCurrentDocumentReference().getWikiReference().getName(),
            "Collections", "LinkCollectionTemplate");
    }
}
